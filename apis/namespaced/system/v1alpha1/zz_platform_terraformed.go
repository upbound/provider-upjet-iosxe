...
// GetInitParameters of this Platform
func (tr *Platform) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Platform
func (tr *Platform) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
