...
func (tr *Logging) GetObservation() (map[string]any, error) {
...
func (tr *Logging) SetObservation(obs map[string]any) error {
...
func (tr *Logging) GetParameters() (map[string]any, error) {
...
func (tr *Logging) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Logging
func (tr *Logging) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Logging
func (tr *Logging) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
