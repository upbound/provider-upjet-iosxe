...
// GetInitParameters of this NAT
func (tr *NAT) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this NAT
func (tr *NAT) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
